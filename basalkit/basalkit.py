...
#            seq_context_str = ["GAC","AAC","YAC","GAD","AAD","YAD","DRACH"]
        ...
        os.system("sort -k1b,1 -k2n,2 {}.unsrt > {}.srt;rm {}.unsrt;uniq -c {}.srt | awk '{for(i=2;i<=7;i++){printf $i"\t"};if(NF==7){print {}}else{print {}"\t"$8"\t"$9}}' > {};rm {}.srt;bgzip {};tabix -b 2 -e 3 {}.gz;".format(args.output))
